...
| SR-LEDGER-012 | MT4/MT5 account snapshots and orders feed canonical ledger; authoritative closed-deal/P&L/commission/swap history is ingested | IN_PROGRESS | snapshots/orders: `services/mt5_signal_router.py`; closed-deal adapter not yet present | snapshot/order source coverage | architecture companion | Snapshot/order commit `bee2e89`; provider-authoritative history ingestion remains open |
