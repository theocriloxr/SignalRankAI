...
| LTD-C08 | Decision intelligence lifecycle integration | Active `engine/core.py` decisions now preserve raw decision/reason while structured decision intelligence derives normalized issued/rejected/skipped/delayed/suppressed lifecycle disposition. Legacy direct-log loop/strategy-runner surfaces are test/demo-only, not production runtime. | Clean-room commit `8766ceaea3edc25ee62166bd91d679595cff1eed`: Alembic 0045/schema/provenance PASS; `tests/test_decision_intelligence.py` included; 356 targeted tests passed. | 2026-06-29 | 2026-09-26 | Engineering |
| LTD-C09 | Outcome tracker architecture split | `RealtimeOutcomeTracker` is the sole canonical live market-observation/lifecycle writer; `OutcomeReconciliation` is projection/repair-only from persisted `SignalLifecycle` evidence; shadow outcome tracking remains an ML/counterfactual domain. Legacy `ENGINE_OUTCOME_TRACKER_ENABLED` is compatibility-only and invalid for current deployment profiles. | `core/outcome_ownership.py`, `tests/test_outcome_ownership_contract.py`; clean-room commit `b784165aeccfbc897034a16b14865b1a65f8cb11`: Alembic 0045/schema/provenance PASS and 364 targeted tests PASS. | 2026-06-29 | 2026-09-26 | Engineering |
| LTD-C10 | Enterprise observability maturity | Canonical SLOs now publish live error-rate/budget/sample/degraded metrics and are covered one-to-one by typed alert ownership, Prometheus warning/critical/provider/service rules, a Grafana SLO overview dashboard, and a safety-preserving incident runbook. | Clean-room commit `d37b8c8aa1ec5f934a6c4b52676bc38cc13c03f1`: Alembic 0045/schema/provenance PASS; `tests/test_observability_operations_contract.py` included; 368 targeted tests passed. | 2026-06-29 | 2026-09-26 | Engineering |
