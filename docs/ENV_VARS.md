...
|---|---|---|---|---|
| `DATABASE_URL` | `str` | `PydanticUndefined` | yes | test_health_http.py, config.py, run_server.py |
...
| `REDIS_URL` | `Optional` | `` | yes | config.py, run_server.py, test_exact_healthz.py |
