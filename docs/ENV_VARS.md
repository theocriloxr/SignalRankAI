...
| `REDIS_URL` | `Optional` | `` | yes | config.py, tests/test_bypass_rotation.py, core/redis_state.py |
| `RUN_MODE` | `str` | `engine` | yes | main.py, telegram/bot.py, core/settings.py |
...
| `TELEGRAM_BOT_TOKEN` | `Optional` | `` | yes | config.py, railway_main.py, core/settings.py |
