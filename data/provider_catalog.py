...
PROVIDER_SPECS: tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        "polygon", "Massive (formerly Polygon.io)", "data.connectors.polygon_adapter", "get_candles",
        ...
        required_env=("MASSIVE_API_KEY", "POLYGON_API_KEY"),  # one consolidated secret
    ...
    ProviderSpec(
        "coingecko", "CoinGecko / GeckoTerminal", "data.connectors.coingecko_adapter", "get_candles",
        ("crypto_spot",), ("spot", "dex_pool"), ("1h", "1d"),
        ("discovery", "metadata", "last_resort_fallback"),
        "https://docs.coingecko.com/",
        public_endpoint=True, realtime_capable=False, default_enabled=True,
        sample_symbol="BTCUSDT", sample_timeframe="1h",
        notes="Keyless public discovery/context; free API honestly serves 1h/1d only (finer granularity fails closed). Never the final execution quote.",
    ),
    ProviderSpec(
        "coinmetrics", "Coin Metrics Community", "data.connectors.coinmetrics_adapter", "get_candles",
        ("crypto_spot",), ("spot",), ("1m", "5m", "15m", "1h", "4h", "1d"),
        ("historical", "network_metrics", "public"),
        "https://docs.coinmetrics.io/api/v4",
        public_endpoint=True, realtime_capable=False, default_enabled=True,
        sample_symbol="BTCUSDT", sample_timeframe="1d",
        notes="Community API is keyless; Pro API activates via COIN_METRICS_API_KEY.",
    ),
    ProviderSpec(
        "defillama", "DefiLlama", "data.connectors.defillama_adapter", None,
        ("onchain_pool", "crypto_spot"), ("dex_pool", "stablecoin", "yield_pool"), ("1d",),
        ("on_chain", "discovery", "context"), "https://defillama.com/docs/api",
        public_endpoint=True, realtime_capable=False, default_enabled=True,
        sample_symbol="USDCUSDT", sample_timeframe="1d",
        notes="Context/discovery only; no candle endpoint, never execution truth.",
    ),
    ProviderSpec(
    ...
    ProviderSpec(
        ...
        ("macro", "interest_rate"), ("calendar", "indicator", "analysis"), ("1d",),
        ("economic_calendar", "macro"), "https://docs.tradingeconomics.com/",
        required_env=("TRADING_ECONOMICS_API_KEY",), realtime_capable=False, default_enabled=False,
        notes="Consensus-vs-actual calendar; dormant without credentials.",
    ),
    ProviderSpec(
        "coinglass", "CoinGlass", "data.connectors.coinglass_adapter", None,
        ("crypto_perpetual",), ("perpetual",), ("1m", "5m", "15m", "1h", "4h", "1d"),
        ("derivatives_intelligence", "funding", "open_interest"), "https://docs.coinglass.com/",
        required_env=("COINGLASS_API_KEY",), realtime_capable=False, default_enabled=False,
        notes="Capabilities reflect the subscribed plan; dormant without credentials.",
    ),
    ProviderSpec(
        "dune", "Dune", "data.connectors.dune_adapter", None,
        ("onchain_pool",), ("on_chain",), ("1d",), ("on_chain", "analytics"),
        "https://docs.dune.com/api-reference/",
        required_env=("DUNE_API_KEY",), realtime_capable=False, default_enabled=False,
        notes="Scheduled SQL queries; dormant without credentials.",
    ),
    ProviderSpec(
        "kaiko", "Kaiko", "data.connectors.kaiko_adapter", None,
        ("crypto_spot", "crypto_perpetual"), ("spot", "perpetual"), ("1m", "5m", "1h", "1d"),
        ("institutional", "reference_data"), "https://docs.kaiko.com/",
        required_env=("KAIKO_API_KEY",), realtime_capable=False, default_enabled=False,
        notes="Institutional normalized data; dormant without credentials.",
    ),
    ProviderSpec(
        "glassnode", "Glassnode", "data.connectors.glassnode_adapter", None,
        ("crypto_spot", "onchain_pool"), ("on_chain",), ("1d",), ("on_chain", "institutional"),
        "https://docs.glassnode.com/",
        required_env=("GLASSNODE_API_KEY",), realtime_capable=False, default_enabled=False,
        notes="Paid on-chain API; dormant without credentials.",
    ),
    ProviderSpec(
        "cryptoquant", "CryptoQuant", "data.connectors.cryptoquant_adapter", None,
        ("crypto_spot", "onchain_pool"), ("on_chain",), ("1d",), ("on_chain", "institutional"),
        "https://docs.cryptoquant.com/",
        required_env=("CRYPTOQUANT_API_KEY",), realtime_capable=False, default_enabled=False,
        notes="Institutional on-chain; dormant without credentials.",
    ),
)
