...
## Unified web, mobile and Telegram platform (v1.5.1)

- Web/PWA: `/app`
- Unified API: `/api/v1/platform`
- Mobile source: `mobile/`
- Current migration head: `0040_cross_channel_paper_receipts`
...
release expects `0040_cross_channel_paper_receipts`, use the guarded terminal
