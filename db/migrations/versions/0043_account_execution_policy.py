...
def upgrade() -> None:
    ...
    op.execute(
        ...
        INSERT INTO trading_account_policies(
            ...
            max_risk_per_trade_pct,max_daily_loss_pct,max_total_drawdown_pct,
            max_open_positions,max_leverage,safety_buffer_pct,
            allowed_instruments,allowed_asset_classes,
