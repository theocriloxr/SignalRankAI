...
def test_current_environment_profiles_are_present() -> None:
    assert (ROOT / "SignalRankAI_v1.2.8_Railway_Production_Launch.env.example").exists()
    assert (ROOT / "SignalRankAI_v1.2.8_Railway_Full_System_Live_Paystack_Staging.env.example").exists()
