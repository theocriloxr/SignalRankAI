...
async def process_event(event):
    ...
    # Send Telegram confirmation (MarkdownV2V2 escaped)
    try:
        ...
        def escape_md(text):
            # Escape all MarkdownV2V2 special chars
        ...
        await bot.send_message(chat_id=int(telegram_user_id), text=msg, parse_mode="MarkdownV2V2")
    except Exception:
        pass
