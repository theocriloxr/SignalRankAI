"""Static/runtime verifier for SignalRankAI v1.2.6."""
...
def main() -> None:
    ...
    require(APP_VERSION == "1.2.6", "runtime code version")
    require(RELEASE_FINGERPRINT == "v1.2.6-callback-outcome-recovery-20260730", "release fingerprint")
    ...
    profile = ROOT / "SignalRankAI_v1.2.6_Railway_Full_System_Live_Paystack_Staging.env.example"
    require(profile.exists(), "v1.2.6 Railway staging profile")
    print("v1.2.6 verification complete")
