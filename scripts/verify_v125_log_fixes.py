...
def main() -> int:
    ...
    require(APP_VERSION == "1.2.7", "runtime code version retains v1.2.5 fixes")
    require(RELEASE_FINGERPRINT == "v1.2.7-outcome-price-production-gate-20260730", "release fingerprint")
    ...
    profile = ROOT / "SignalRankAI_v1.2.7_Railway_Full_System_Live_Paystack_Staging.env.example"
