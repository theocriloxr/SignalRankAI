...
def main() -> int:
    ...
    require(APP_VERSION == "1.2.8", "runtime code version retains v1.2.5 fixes")
    require(RELEASE_FINGERPRINT == "v1.2.8-outcome-perf-readiness-hotfix-20260730", "release fingerprint")
    ...
    profile = ROOT / "SignalRankAI_v1.2.8_Railway_Full_System_Live_Paystack_Staging.env.example"
