...
def main() -> None:
    ...
    require(APP_VERSION == "1.2.7", "runtime version")
    require(
    ...
    production = ROOT / "SignalRankAI_v1.2.7_Railway_Production_Launch.env.example"
    staging = ROOT / "SignalRankAI_v1.2.7_Railway_Full_System_Live_Paystack_Staging.env.example"
