...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("ai_status", "View AI routing, models, budget, and circuit state", "OWNER", "Owner"),
    CommandSpec("ai_test", "Verify the OpenAI Responses API connection", "OWNER", "Owner"),
