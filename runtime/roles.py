...
ROLE_SPECS: Mapping[RunMode, RoleSpec] = {
    ...
    RunMode.SCHEDULER: RoleSpec(RunMode.SCHEDULER, "Due-job publication", "Singleton scheduler lease", ()),
    RunMode.ALL_DEV: RoleSpec(RunMode.ALL_DEV, "Compatibility composition", "All roles in one local process", ("all", "dev")),
}
