...
RUN python -m compileall -q engine db data worker services ml signalrank_telegram \
    && python -m pytest -q \
      ...
      tests/test_fetcher_async.py::TestAsyncFetcher::test_fx_class_attempt_budget_reaches_third_provider \
      tests/test_fetcher_async.py::TestAsyncFetcher::test_crypto_budget_remains_global_default_when_no_class_override \
